...
class Export_Leader_Form_Class(QWidget):
    def __init__(self):
        super().__init__()
        self.title = "TechTG"
        self.top = 200
        ...
        self.button_export_one_chat = QPushButton("Выгрузить информацию о лидерах по одному чату")
        ...
        self.button_export_all_chat = QPushButton("Выгрузить информацию о лидерах по всем чатам")
