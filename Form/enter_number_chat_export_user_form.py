...
class Enter_Number_User_Form(object):
# Инициализация и создание формы окна авторизации
    def setupUi(self, Enter_Number_User_Form):
        Enter_Number_User_Form.setObjectName("EnterDateForm_one_chat")
        Enter_Number_User_Form.resize(567, 515)
        Enter_Number_User_Form.setMinimumSize(QtCore.QSize(300, 230))
        Enter_Number_User_Form.setMaximumSize(QtCore.QSize(300, 230))
        self.centralwidget = QtWidgets.QWidget(Enter_Number_User_Form)
        ...
        self.statusbar = QtWidgets.QStatusBar(Enter_Number_User_Form)
        self.retranslateUi(Enter_Number_User_Form)
        QtCore.QMetaObject.connectSlotsByName(Enter_Number_User_Form)
 # Конец инициализация и создание формы окна авторизации



# Первичные данные инициализации
    def retranslateUi(self, Enter_Number_User_Form):
        _translate = QtCore.QCoreApplication.translate
        Enter_Number_User_Form.setWindowTitle(_translate("EnterDate", "TechTG"))
