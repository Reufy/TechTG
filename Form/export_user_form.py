...
class Export_User_Form_Class(QWidget):
    def __init__(self):
        super().__init__()
        self.title = "TechTG"
        self.top = 200
        ...
        self.button_export_one_chat = QPushButton("Выгрузить список участников из одного чата")
        ...
        self.button_export_all_chat = QPushButton("Выгрузить список участников из всех чатов")
