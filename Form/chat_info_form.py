...
class Chat_info_Form_Class(QWidget):
    def __init__(self):
        super().__init__()
        self.title = "TechTG"
        self.top = 200
        ...
        self.button_export_one_chat = QPushButton("Выгрузить информацию по одному чату")
        ...
        self.button_export_all_chat = QPushButton("Выгрузить информацию по всем чатам")
